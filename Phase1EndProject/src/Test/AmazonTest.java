...
public class AmazonTest {
	...
	public static void main(String[] args) {
		...
		List<WebElement> rupees = driver.findElements(By.xpath("//div[@class='sg-row']//following::span[@class='a-price-symbol'][1]"));

		System.out.println("All name size:" + product_names.size());
		System.out.println("All price size:" + product_price.size());
		System.out.println("All symbol size:" + rupees.size());
